...
// Itinerario del día. icon ∈ church | glass | dinner | party
export const itinerary = [
  { time: "18:00", label: "Ceremonia religiosa", icon: "church" },
  { time: "19:30", label: "Recepción", icon: "glass" },
  { time: "22:00", label: "Cena", icon: "dinner" },
  { time: "00:00", label: "Fiesta", icon: "party" },
];
...
export const rsvp = {
  ...
  intro: "Esperamos compartir este día tan especial con vos.",
};
  ...
  accounts: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "N° de cuenta", value: "CA u$s 00020007381852" },
        { name: "CUIL", value: "20372110458" },
      ],
    },
  ],
};

// Galería — reemplazá por tus fotos en /public/assets/photos
export const gallery = [
  { src: "/assets/photos/couple_1.webp", alt: "Nahiara y Rodrigo" },
  { src: "/assets/photos/couple_2.webp", alt: "Nahiara y Rodrigo" },
  { src: "/assets/photos/couple_3.webp", alt: "Nahiara y Rodrigo" },
];
